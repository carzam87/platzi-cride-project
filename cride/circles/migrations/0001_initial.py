# Generated by Django 2.0.9 on 2021-06-01 05:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_limited', models.BooleanField(default=False, help_text='Limited number of circles can grow up to a fixed number of members', verbose_name='limited')),
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If circle is limited, this will be then limit on the number of members.')),
            ],
            options={
